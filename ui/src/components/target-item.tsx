                                        ...
                                        >
                                                    ...
                                                    {getParameters(tool).map((param) => (
                                                        <div key={param.name} className="space-y-1">
                                                            ...
                                                            <Input
                                                                ...
                                                                onChange={(e) => handleToolParamChange(tool.name, param.name, e.target.value)}
                                            ...
                                            {toolResults[tool.name] && (
                                                <div className="mt-3">
                                                    ...
                                                    <div className={`p-2 mt-1 rounded-md text-xs ${
                                                        toolResults[tool.name].isError ? 'bg-destructive/10 text-destructive' : 'bg-muted'
                                                    }`}>
                                                        {Array.isArray(toolResults[tool.name].content) && 
                                                         (toolResults[tool.name].content as Array<{ text: string } | string>).map((item, i) => {
